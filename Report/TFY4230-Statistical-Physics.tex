...
\documentclass[10pt,a4paper,apm,twocolumn,secnumarabic,numerical,balancelastpage,nofootinbib,superscriptaddress]{revtex4-2}
...
\maketitle
	...
	\begin{figure*}[htb]
		...
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/P_01_0000.tex"}}
			\caption{Path of one particle with $\Delta t=0.001$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/P_01_0005.tex"}}
			\caption{Path of one particle with $\Delta t=0.005$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/P_01_0010.tex"}}
			\caption{Path of one particle with $\Delta t=0.010$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/P_01_0020.tex"}}
	...
	\begin{figure*}[htb]
		\centering
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/E_01_0000.tex"}}
			\caption{Energy drift with $\Delta t=0.001$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/E_01_0005.tex"}}
			\caption{Energy drift with $\Delta t=0.005$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/E_01_0010.tex"}}
			\caption{Energy drift with $\Delta t=0.010$}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\scalebox{0.6}{\input{"./figures/E_01_0020.tex"}}
